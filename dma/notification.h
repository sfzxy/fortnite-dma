...
#include "render/ImGui/imgui_settings.h"
...
namespace ImGui
{
	...
	NOTIFY_INLINE VOID RenderNotifications()
	{
		...
		//		GetForegroundDrawList()->AddRectFilled(pos + ImVec2(0, 0), pos + ImVec2(region.x + 20, 5), GetColorU32(c::accent), 30.f, ImDrawCornerFlags_Bot);
